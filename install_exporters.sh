...
export BOND_DENOM=$1
export BENCH_PREFIX=$2
export RPC_PORT=${3:-26657}
export GRPC_PORT=${4:-9090}

echo -e "\e[1m\e[32m1. Installing cosmos-exporter... \e[0m"
...
echo -e "\e[1m\e[32m2. Installing node-exporter... \e[0m"
...
echo -e "\e[1m\e[32mPlease make sure ports 9100 and 9300 are open \e[0m"
